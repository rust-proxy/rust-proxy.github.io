...
本页介绍客户端的安装、启动与配置。服务端请见[服务端](server.md)；最小配置与验证步骤见[快速入门](getting-started.md)；完整示例与字段说明见[配置编辑器](/config-editor/?schema=tuic-client)。
...
[打开客户端配置编辑器](/config-editor/?schema=tuic-client){ .md-button .md-button--primary }
