"""Check assembled site links and the standalone generator's privacy/assets."""
...
for asset in assets:
    ...
    target = root / url.path.lstrip('/') if url.path.startswith('/') else generator_path.parent / url.path
