...
const previewText = async () => (await page.locator('.cg-desc-line code').allTextContents()).join('\n');
...
try {
  ...
  assert.equal(await id('host').count(), 1, 'selection region shows the generator form');
