...
Internet standard. It extracts the static XML dialect introduced by the TUIC
config generator into a contract for other configuration generators. Wind does not yet implement
